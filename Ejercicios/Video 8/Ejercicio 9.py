...
## 1
# Utiliza las funciones correspondientes para imprimir la longitud del diccionario 'diccionarioDeFrutas'.
# Ejecuta el ejercicio.
# La respuesta debe ser 4.

diccionarioDeFrutas = {'Manzana':'rojo', 'Banana':'amarillo', 'Uva':'violeta', 'Naranja':'naranja'}
